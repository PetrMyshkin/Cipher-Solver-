...
def analyze_vigenere(ciphertext, min_matches=2):
    ...
    common_keys = ["a","b","c","d","key","love","code","secret",
                   "cipher","cat","dog","test","abc","xyz"]
...
def main():
    ...
    st.markdown("**Automatically detect and solve Caesar and Vigenère ciphers** (no NLTK needed!)")
